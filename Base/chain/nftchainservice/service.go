...
type NodeService interface {
	...
	GetNFTTransferEvent(chainName string, formBlock, toBlock uint64) ([]*TransferLog, error)
...
func New(ctx context.Context, endpoint, chainName string, chainID int, nameTags, imageTags, attributesTags, traitNameTags, traitValueTags []string) (*Service, error) {
